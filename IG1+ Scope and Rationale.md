...
This document serves as a high-level description of the CIS Safeguards included in the CSS Cybersecurity Assessment Team "IG1+" review baseline with brief explanations of how each included Safeguard aligns to the _2023 Satatewide Information Technology Control Standards_ and, where applicable, ratonale for included "IG2" and "IG3" Safeguards.
