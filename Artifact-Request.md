...
Organization’s documented security awareness training program plan for educating organization personnel on how to interact with organization data and assets in a secure manner. Agencies may leverage the Statewide Human Risk Management Information Security Awareness and Training (HRM-ISAT) Plan if they do not maintain their own Awareness Training plan.
