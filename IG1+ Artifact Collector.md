...
**About:**
Script to extract an inventory of 'discovered' assets from Artifact Collector.  Note - You will need to run these commands in the same directory/folder where your Artifact Collector result files are saved.
